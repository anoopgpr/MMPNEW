        ...
        **********************************************************/
        _onMoveEnd: function () {
			 ...
			 if(base.data.currentSlide==2)
			{
				...
				if(localStorage.getItem("usernamecafewanderlust")!=null && localStorage.getItem("usernamecafewanderlust")!='' && localStorage.getItem("passwordcafewanderlust")==null && localStorage.getItem("passwordcafewanderlust")=='')
				{
				 ...
				 if(localStorage.getItem("usernamecafewanderlust")==null || localStorage.getItem("usernamecafewanderlust")=='' )
                                   {
