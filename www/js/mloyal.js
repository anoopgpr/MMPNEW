...
var isRootedORJailBreak=false;
var isTemp=false;
var appkey="64:C1:1E:B3:F6:30:C3:FA:02:06:4A:A7:3A:F7:B5:DE:12:1B:E2:DF";
...
var SERVER = "https://mmp-admin.hyundai.co.in/m/";
var SERVER1 = "https://mmp-admin.hyundai.co.in/";
var GDMSSERVER = "https://bizsupport.hmil.net:9444/hmiws/ew/mmp/";
var REWARDSERVER = "https://mmp-admin.hyundai.co.in/Rewards/";
var CTBSERVER = "https://clicktobuy.hyundai.co.in/ctb/customer";

var TNCURL = "https://mmp-admin.hyundai.co.in/OfrTncFiles/";



var imgSERVER = "https://mmp-admin.hyundai.co.in/";
...
var SERVER = "http://localhost:8086/https://mmp-admin.hyundai.co.in/m/";
var SERVER1 = "http://localhost:8086/https://mmp-admin.hyundai.co.in/";
var GDMSSERVER = "http://localhost:8086/https://bizsupport.hmil.net:9444/hmiws/ew/mmp/";
var REWARDSERVER = "http://localhost:8086/https://mmp-admin.hyundai.co.in/Rewards/";
var CTBSERVER = "http://localhost:8086/https://clicktobuy.hyundai.co.in/ctb/customer";


var TNCURL = "https://mmp-admin.hyundai.co.in/tnc/";
...
var TNCURL = "https://mmptest-admin.hyundai.co.in/OfrTncFiles/";
...
//  }
                  ...
                  if(localStorage.getItem("usernamehyundai")!=null && localStorage.getItem("usernamehyundai")!='' && localStorage.getItem("passwordhyundai")!=null && localStorage.getItem("passwordhyundai")!='')
                    {
                        ...
                        if(user.mobile=='undefined' || user.mobile=='null' || user.mobile==null)
                           ...
                           $('#update_email').val(localStorage.getItem("emailhyundai"));
                            ...
                            document.getElementById("profilenm1").innerHTML= 'Hi ' +user.firstname+'!';
    ...
    function myFunction() {
        var x = document.getElementById("forgot_pass");
        if (x.type === "password") {
            x.type = "text";
          } else {
            x.type = "password";
...
function myFunction4() {
        var x = document.getElementById("update_conpassword");
        if (x.type === "password") {
            x.type = "text";
          } else {
            x.type = "password";
...
function checkVersion()
 {
    ...
    //console.log(SERVER1+'mapp/appversion.json');
     $.ajax({
           
            url: SERVER1+'mapp/appversion.json',
            type: 'GET',
            timeout: 300000,
            dataType: "json",
           ...
           //called when complete
            ...
            success: function(data, textStatus, xhr) {
             ...
             // console.log("VESRIONSSSSSSSSS:"+JSON.stringify(data));
...
function downloadApp(param) {
         ...
         var deviceType = (navigator.userAgent.match(/iPad/i)) == "iPad" ? "iPad" : (navigator.userAgent.match(/iPhone/i)) == "iPhone" ? "iPhone" : (navigator.userAgent.match(/Android/i)) == "Android" ? "Android" : (navigator.userAgent.match(/BlackBerry/i)) == "BlackBerry" ? "BlackBerry" : "null";
           ...
           if(deviceType=='Android')
            url='market://details?id=com.mobiquest.mmphyundai';
           else
            url='itms-apps://itunes.apple.com//in/app/hyundai-mobility-membership/id1526843771?ls=1&mt=8';
...
function resendotpnew()
{
    ...
    $.ajax({
                ...
                // console.log(textStatus);
                 if(data.toLowerCase()=='success'){
                     ...
                     $('#login-msg').html('The  One-time password has been sent to your mobile.Please check your SMS.');
 ...
 $(document).on('pageshow', '#page-forgot-password', function (event, ui) {
     ...
     if(deviceType=='Android'){
        $("#androidreg").css("display","block");
        $("#iphonephreg").css("display","none");
    }
    else{
        $("#androidreg").css("display","none");
        $("#iphonephreg").css("display","block");
    }


       setTimeout(function(){
            var _owl2 = $(".partner_slider");
            _owl2.owlCarousel({
                items:1,
                loop:true,
                margin:0,
 ...
 $(document).on('pageshow', '#registered-user', function (event, ui) {
      // setTimeout(function(){
            var _owl2 = $(".interest_slider");
            _owl2.owlCarousel({
                items:2,
                loop:true,
                margin:10,
...
//{
  ...
  $(document).on('tap', '#forgot_button', function (e, ui) {
     ...
     if($('#forgot_email').val().trim()=='')
       ...
       if(data.dataVO[0].message=='Mobile Number already exists.' || data.dataVO[0].message=='Mobile no. already exists.')
       {
          isCTBexist= true;
        ...
        //$('#update_password').val(localStorage.getItem("profile_pwd"));
          ...
          // str += '<div class="h_logo"><img src="images/logo_white.png" class="img-responsive" /></div>';
           str += 'You are already registered. Please login with same credentials as CTB/H-Promise';
       ...
       if(data.dataVO[0].message=='Email id already exists.' || data.dataVO[0].message=='Email id. already exists.')
       {
          isCTBexist= true;
          $('#userpassdiv').css('display','none');
        //$('#update_password').val(localStorage.getItem("profile_pwd"));
          //toast('You are already registered. Please login with your credentials');
          $('#forgot_useremail').val(email);
          //$.mobile.changePage("#registered-user");
          ...
          document.getElementById("loginbodyemail").innerHTML = str;
          $('#loginpopemail').popup("open");
          ...
          $('#userpassdiv').css('display','block'); 
            ...
            data: {'mobileno':mob,'vinNumber':''},
            success: function(data, textStatus, xhr) {
            // console.log(data.data);
             //console.log(textStatus);
            if(data.error=='Member not registered.')
             {
                isMMPexist= false;  
                $.mobile.changePage("#myaccount");
                ...
                // console.log(textStatus);
                 if(data.toLowerCase()=='success'){
                     ...
                     $('#login-msg').html('The  One-time password has been sent to your mobile.Please check your SMS.');
                      ...
                      localStorage.setItem('emailhyundai',email);
...
$(document).on('pageshow', '#homepage', function (event, ui) {
 ...
 if(new_app=='true')
 {
     ...
     if(deviceType=='Android'){
        $("#andph").css("display","block");
        $("#iphoneph").css("display","none");
    }
    else{
          $("#andph").css("display","none");
        $("#iphoneph").css("display","block");
    }
  ...
  url: SERVER1+'apis/deviceid_update_owin.asp',
   type: 'POST',
   timeout: 50000,
  
    dataType: 'json',
     data: {'mobileno': user.tokenid,'deviceid':localStorage.getItem("reg_id"),'deviceType':deviceType,'latitude':localStorage.getItem('lat'),'longitude':localStorage.getItem('lng')},
    complete: function(xhr, textStatus) {
    },
    success: function(data, textStatus, xhr) {
...
{
    $.mobile.changePage('#downloadpage');
}
...
function showemailform()
{
    $.mobile.changePage('#registered-user');
    getLoginName('Email');
    document.getElementById('radio_email').checked = true;
}
...
function checkuserCTB()
{
    ...
    if(uname=='' || pwd=='')
    {
       toast('Please enter Email ID/Password');
    }
    else
    {
        $.ajax({
           ...
           if(data.dataVO[0].message=='Not a valid customer in CTB system')
           {
                ...
                $('#register-msg').html('Please enter a valid username and password');
                $('#forgot_user').val(localStorage.getItem("usernamehyundai"));
                $('#forgot_pass').val('');
                isCTBexist= false;
                $('#userpassdiv').css('display','block');
           ...
           else  if(data.dataVO[0].message=='Customer has not yet verified registration email.')
           {

                $('#register-msg').html('Customer has not yet verified registration email.');
                $('#forgot_user').val(localStorage.getItem("usernamehyundai"));
                $('#forgot_pass').val('');
                isCTBexist= false;
                $('#userpassdiv').css('display','block');
           ...
           else
           {
            ...
            data: {'mobileno': user.mobile,'vinNumber':''},
               beforeSend  : function() {
                  $("#wait").css("display","block");
            },
            complete: function() {
            ...
            success: function(data, textStatus, xhr) {
            // console.log(data.data);
    if(data.error=='Member not registered.' || data.data=='Member registered but vehicle number not provided'
) {
                isMMPexist= false;  
                $.ajax({
                url: SERVER+'forgot_pswd.asp',
                ...
                // console.log(textStatus);
                 if(data.toLowerCase()=='success'){
                     ...
                     $('#login-msg').html('The  One-time password has been sent to your mobile.Please check your SMS.');
                      ...
                      localStorage.setItem('usernamehyundai',user.mobile);
                      localStorage.setItem('emailhyundai',uname);
    ...
    else
    {
        ...
        $.ajax({
           ...
           if(data.dataVO[0].message=='Not a valid customer in CTB system')
           {
                ...
                $('#login-msg').html('Please enter a valid username and password');
                $('#forgot_user').val(localStorage.getItem("usernamehyundai"));
                $('#forgot_pass').val('');
                isCTBexist= false;
                $('#userpassdiv').css('display','block');
           ...
           else  if(data.dataVO[0].message=='Customer Id is disabled. Please use forgot password for enabling Customer Id')
           {

                $('#register-msg').html('Customer Id is disabled. Please use forgot password for enabling Customer Id');
                $('#forgot_user').val(localStorage.getItem("usernamehyundai"));
                $('#forgot_pass').val('');
                isCTBexist= false;
                $('#userpassdiv').css('display','block');
           ...
           else
           {
               ...
               localStorage.setItem('usernamehyundai',user.mobile);
               localStorage.setItem('emailhyundai',user.emailid);
            ...
            data: {'mobileno': user.mobile,'vinNumber':vin},
               beforeSend  : function() {
                  $("#wait").css("display","block");
            },
            complete: function() {
...
function authenticate(uname,pwd,pagename)
{
  ...
  if(phno=='')
    ...
    phno='';
 if(uname=='' || pwd==''){
  $('#login-msg').html('Please enter Mobile Number /One-time password');
 }
 else{
  $.ajax({
   url: SERVER+'mloyallogin_json_owin.asp', //login.php
   type: 'POST',
   timeout: 50000,
    dataType: 'json', //xml/html/script/json/jsonp
    data: {'username': uname, 'password': pwd,'phonenos':phno,'appver':appversion},
   ...
   if(data.status=='success'){
    ...
    user.firstnamemmp = data.firstname;
   ...
   localStorage.setItem("profile_title",user.title);
                localStorage.setItem("profile_fname",user.firstname);
                localStorage.setItem("profile_lname",user.lastname);
                localStorage.setItem("profile_mob",uname);
                localStorage.setItem("profile_addr1",user.address1);
                localStorage.setItem("profile_addr2",user.address2);
                localStorage.setItem("profile_loc",user.location);
                localStorage.setItem("profile_city",user.city);
                localStorage.setItem("profile_state",user.state);
                localStorage.setItem("profile_pin",user.pincode);
                localStorage.setItem("profile_dob",user.dob);
                localStorage.setItem("profile_email",user.emailid);
                localStorage.setItem("profile_user",uname);
                localStorage.setItem("profile_pwd",pwd);
                localStorage.setItem("profile_fvt",data.interest);
 ...
 if(user.mobile=='undefined' || user.mobile=='null' || user.mobile==null)
    ...
    if(user.address2!=null || user.address2!='null')
    ...
    document.getElementById("cardImagemenu").src = uploadURL+'uploads/profile_'+uname+'.jpg';

        document.getElementById('cardImagemenu').src = document.getElementById('cardImagemenu').src + '?' + (new Date()).getTime();
    ...
    document.getElementById("cardImagemenu").src = uploadURL+'uploads/profile_'+localStorage.getItem("usernamehyundai")+'.jpg';
    document.getElementById('cardImagemenu').src = document.getElementById('cardImagemenu').src + '?' + (new Date()).getTime();
    ...
    else
    {
     ...
     if(localStorage.getItem('newreg')=='newreg')
     {

        $('#regcompletepop').popup("open");
        localStorage.setItem('newreg','');
...
$(document).on('pageinit', '#profilepage', function (event, ui) {
        ...
        document.getElementById("update_email").readOnly = true;
...
$('#update_username').val(localStorage.getItem("usernamehyundai"));
        ...
        {
          $('#update_password').val(localStorage.getItem('ctbpasswordhyundai'));
          $('#update_conpassword').val(localStorage.getItem('ctbpasswordhyundai'));
        }
        ...
        else if($('#update_firstname').val().trim()=='')
        {
...
function customerRegistrationcheck()
{
    if($('#vin_name').val().trim()=='')
        {
                toast('Vehicle Nickname cannot be blank');
                document.getElementById('vin_name').focus();
                document.getElementById('vin_name').scrollIntoView();
        }
    else
        {
...
function customerRegistration(newreg)
{
...
"agreedRecEmailNews": sub, "agreedTermCond": tnc,"agreedPrvPolicy": tnc}}),
          ...
          // if(data.dataVO[0].message=='CTB customer registration success.' || data.dataVO[0].message=='Customer cannot be registered because email id exists.' || data.dataVO[0].message=='Customer cannot be registered because Mobile Number. exists.')
          ...
          data: {
            ...
            success: function(data, textStatus, xhr) {
                ...
                if (data.indexOf("Success")>=0)
                {
                        ...
                        localStorage.setItem("profiledone_hyundai","true");
                        localStorage.setItem("newreg",newreg);
...
"address1" : addr1,"address2" : addr2, "location" : loc, "stateCode" : st[1], "cityCode" : ct[1],"pinCode" : pin,
"agreedRecEmailNews": sub, "agreedTermCond": tnc,"agreedPrvPolicy": tnc,"registrationMode":"E","registrationSource":"HMM"}}),
             beforeSend: function (xhr) {
          ...
          // if(data.dataVO[0].message=='CTB customer registration success.' || data.dataVO[0].message=='Customer cannot be registered because email id exists.' || data.dataVO[0].message=='Customer cannot be registered because Mobile Number. exists.')
           if(data.dataVO[0].message=='CTB customer registration success.' || data.dataVO[0].message=='CTB customer registration and login success.')
           {
               //call mloyal registration
...
function updateprofile()
{
        ...
        if($('#update_title1').val().trim()=='' || $('#update_title1').val()==null)
        {
                toast('Title cannot be blank');
                $('#update_title1').focus();
                $('#update_title1').scrollIntoView();
        }
        else if($('#update_firstname1').val().trim()=='')
        {
                toast('FirstName cannot be blank');
...
if(url!=''){
 ...
 {
    toast('No terms and condiotions defined!');
 }
...
function showinterestpage()
{
    ...
    //$.mobile.changePage('#personalize', { transition: "none"} );

}
function closepopoffer()
{
    
    $('#profilecompletepop').popup("close");
...
function showcatbrands(catid){
    ...
    if(user.vinno=='')
    {
        $('#profilecompletepop').popup("open");
        

        //$.mobile.changePage('#personalize');
    }
else
{
    //return;
 setTimeout(function(){
    ...
    */
    ...
    if(catid == 'All')
        catid = '';
    $.ajax({
    url: SERVER1+'apis/view_couponlist_json_api_owin.asp',
    type: 'GET',
    timeout: 50000,
    dataType: 'json', //xml/html/script/json/jsonp
    data: {'mobileno': user.tokenid,'vehicletype':'all','cid':catid},
    success: function(data, textStatus, xhr) {
    ...
    localStorage.setItem('data2',JSON.stringify(data));
        ...
        $.ajax({
    url: SERVER1+'apis/view_issued_coupon_json_api_owin.asp',
    type: 'GET',
    timeout: 50000,
    dataType: 'json', //xml/html/script/json/jsonp
    data: {'mobileno': user.tokenid,'cid':catid},
    success: function(data, textStatus, xhr) {
   ...
   if(data.data=='Coupons not available.')  
    {
        localStorage.removeItem('data1');
         ...
         renderTemplate('reward-brand1', JSON.parse(localStorage.getItem('data2')));
    ...
    else if(globalcatid == '')
    {
        ...
        {
         if(data.data[i].CouponFlag == 'Activated' || data.data[i].CouponFlag == 'Redeemed')
          {
            noofacive++;
            ...
            if(cimg!='')
             ...
             str += '<div class="coupon_block"><div class="coupon_img2"><img src="'+imgSERVER+data.data[i].BrandLogo+'" class="img-responsive"></div>';
              ...
              //    str += '<h2>'+data.data[i].Brand+'</h2>';
                ...
                str += '<li>';
                str += '<h3>Activation Date :</h3> <span>'+data.data[i].CouponActivationDate+'</span>';
                str += '</li>';
                str += '<li>';
                str += '<h3>Redeemed Date :</h3> <span></span>';
                str += '</li>';
                ...
                try{
                    ...
                    if(data.data[i].offer_tnc==''|| typeof data.data[i].offer_tnc == undefined || data.data[i].offer_tnc == null)
                    brandlink='';
                    else
                    brandlink=TNCURL+data.data[i].offer_tnc; 
        ...
        if(noofacive==0)
        {
            ...
            document.getElementById("errorfunction").href="javascript:showHome1()";
            document.getElementById("faildesc").innerHTML = 'No Active Offer Found!';
        }
        else
        {
...
function showcatbrandsbybrand(catid,brandid){
...
function closepop(url,str)
{

    $('#disclaim').popup("close");
    openInWebView(url,str);
...
function openInWebView2(url,str)
{
      
// https://stagingb2bapi.zee5.com/cl/premium-packs.php?code=ATHMH7BS0SJ420LK&name=Hyundai&utm_source=cl&utm_medium=hyundai&utm_campaign=web&mobile='+localStorage.getItem('usernamehyundai')
  

/*

  $.ajax({
    url: 'https://stagingb2bapi.zee5.com/cl/premium-packs.php',
    type: 'GET',
    timeout: 50000,
    dataType: 'html',                       
    data:{'code': 'ATHMH7BS0SJ420LK',
  'name': 'Hyundai',
  'utm_source': 'cl',
  'utm_medium': 'Hyundai',
  'utm_campaign': 'web'},
    beforeSend: function (xhr) {                   
    xhr.setRequestHeader('mobile',localStorage.getItem('usernamehyundai'));
    },
     complete: function(xhr, textStatus) {
    ...
    success: function(data, textStatus, xhr) {
        document.getElementById('zeecon').innerHTML=data;
        $.mobile.changePage('#zee');
  ...
  let promise = fetch('http://localhost:8086/https://stagingb2bapi.zee5.com/cl/premium-packs.php?code=ATHMH7BS0SJ420LK&name=Hyundai&utm_source=cl&utm_medium=hyundai&utm_campaign=web', {
  method: "GET", // POST, PUT, DELETE, etc.
  headers: {
    // the content type header value is usually auto-set
    // depending on the request body
    "mobile": localStorage.getItem('usernamehyundai')
  },
...
*/
url=url+'&mobile='+btoa(user.mobile);
//console.log(url);
 
        $('#disclaim').popup("open");
        $("#cpop").attr("href", "javascript:closepop('"+url+"','"+str+"');");
        $("#cpop1").attr("href", "javascript:closepop1('"+url+"','"+str+"');");
       
}


function openInWebView3()
{
...
url='https://www.manipalhospitals.com/hyundai-registration?salutation='+$('#update_title1').find(":selected").text().toUpperCase()+'&lastname='+$('#update_firstname1').val()+'&mobile='+$('#update_pmobile1').val()+'&email='+user.emailid+'&dob='+user.dob+'&state='+$('#update_state1').find(":selected").text()+'&city='+$('#update_city1').find(":selected").text()+'&address='+user.address1;
str='Manipal Hospitals';
//url='https://www.manipalhospitals.com/hyundai-registration'+'&mobile='+btoa(user.mobile);
//console.log(url);
...
function openInWebViewmobis(str)
    {
        if(str=='model'){
           var pdfname=$('#itemname1').val();
           var url=SERVER1+'mapp/PDFs/'+pdfname
        ...
        {
             var url=SERVER1+'mapp/PDFs/common.pdf'
...
function openInWebViewmobis1(str)
    {

          if(str=='model'){
           var pdfname=$('#itemname').val();
           var url=SERVER1+'mapp/PDFs/'+pdfname;
...
function openInWebView1(url,str)
    {
...
function openInWebView(url,str)
    {
      ...
      if(url.indexOf('http')>=0){
          ...
          inAppBrowserRef=cordova.InAppBrowser.open(url, '_blank', 'location=no');
    ...
    document.getElementById('oflinem').innerHTML=url;
     $('#offlinemsg').popup("open");
        $("#cpop2").attr("href", "javascript:closepop2('"+url+"','"+str+"');");
    }
...
function openInWebViewUI(url,str)
    {
        ...
        var url='';
         ...
         var deviceType = (navigator.userAgent.match(/iPad/i)) == "iPad" ? "iPad" : (navigator.userAgent.match(/iPhone/i)) == "iPhone" ? "iPhone" : (navigator.userAgent.match(/Android/i)) == "Android" ? "Android" : (navigator.userAgent.match(/BlackBerry/i)) == "BlackBerry" ? "BlackBerry" : "null";
             ...
             if(deviceType=='null')
                deviceType='Android';
           if(deviceType=='Android')
            url='market://details?id=com.bsl.hyundai';
           else
            url='itms-apps://itunes.apple.com//in/app/hyundai-mobility-membership/id762106145?ls=1&mt=8';
window.location.href=url;
   //        window.open(url);
              ...
              if(json[i].AdVideoURL=='' || json[i].AdVideoURL==null  || json[i].AdVideoURL=='null')
                {
                    ...
                    if(json[i].AdLinkURL=='')
                        str += '<a href=javascript:showcatbrands(\''+json[i].AdDesc+'\')><img src='+imgSERVER+'/m/'+json[i].AdImgURL+' alt="" class="img-responsive" /></a>';
                    else
   ...
   for (var i=0;i<json.data.length;i++ )
  {
        ...
        */
        ...
        if(!brandarr.includes(json.data[i].BrandId))
        {
            ...
            //else
                str += '<a href="#" class="offer_btm btn_animation" onclick = "javascript:getVoucher(\''+json.data[i].BrandId+'\', \''+json.data[i].Brand+'\', \''+json.data[i].offer_frequency_type+'\');" >';
...
/*          if(json.data[i].BrandId=='5')
   ...
   for (var i=0;i<json.data.length;i++ )
  {
    ...
    {
        if(globalbrandid == json.data[i].BrandId)
        {
            if(!brandarr.includes(json.data[i].BrandId))
            {
            brandarr.push(json.data[i].BrandId);
  ...
  var newjson=JSON.parse(localStorage.getItem('data1'));
  ...
  for (var i=0;i<newjson.data.length;i++ )
  {
        if(globalbrandid == '')
        {
            if(!brandarr.includes(newjson.data[i].BrandId))
            {
                brandarr.push(newjson.data[i].BrandId);
                str += '<a href="#" class="offer_btm btn_animation" onclick = "javascript:getVoucher(\''+newjson.data[i].BrandId+'\', \''+newjson.data[i].Brand+'\', \''+newjson.data[i].offer_frequency_type+'\');" >';
                str +='<div class="coupon_img"><img src="'+imgSERVER+newjson.data[i].BrandLogo+'" class="img-responsive"></div>';
                str += '<div class="brand_name">';
                str += '</div>';
                str += '<div class="ls_block">';
                str += '<h1 class="offer_heading">'+newjson.data[i].Brand+'</h1>';
                str += '<div class="text-center mt-10">';
                str += '<span class="btn_primary " data-role="none" >View Offers</span>';                               
                str += '</div>';
                str += '</div>';
        ...
        //console.log(str);
        $("#reward-brand .ui-content").html(str);
        localStorage.setItem('golbalstr',str);
...
var str = '';
    ...
    switch (pageID) {
        ...
        case 'aboutus':
            ...
            document.getElementById("cardid").innerHTML = 'Membership No: '+ uuu;
...
function showAllBrands(catid)
{
    ...
    data: {'mobileno': user.tokenid,'vehicletype':'all','cid':catid},
    success: function(data, textStatus, xhr) {
    console.log('data in new func'+JSON.stringify(data));
    ...
    for(var i=0;i<data.data.length;i++)
    {
        /*if(catid != '')
        {
            if(catid == data.data[i].CategoryId)
            {
            if(brandlist.indexOf(data.data[i].Brand)==-1)
                brandlist.push(data.data[i].Brand);
            }
        }
        else
        {
        ...
        str += '<div class="filterDiv '+data.data[i].Category+'" onclick="javascript:getVoucher(\''+data.data[i].BrandId+'\',\''+data.data[i].Brand+'\', \''+data.data[i].offer_frequency_type+'\');"><div class="partner_logo"><img src="'+imgSERVER+'/'+data.data[i].BrandLogo+'" class="img-responsive"></div><span>'+data.data[i].Brand +'</span></div>';
        }
    ...
    data: {'mobileno': user.tokenid,'cid':catid},
    success: function(data, textStatus, xhr) {
        console.log('data in iss func'+JSON.stringify(data));
        localStorage.setItem('data1',JSON.stringify(data));
        for(var j=0;j<data.data.length;j++)
        {
            if(brandlist.indexOf(data.data[j].Brand)==-1)
            {
                brandlist.push(data.data[j].Brand);
                console.log('here');
                str += '<div class="filterDiv '+data.data[j].Category+'" onclick="javascript:getVoucher(\''+data.data[j].BrandId+'\',\''+data.data[j].Brand+'\', \''+data.data[j].offer_frequency_type+'\');"><div class="partner_logo"><img src="'+imgSERVER+'/'+data.data[j].BrandLogo+'" class="img-responsive"></div><span>'+data.data[j].Brand +'</span></div>';
            }
        }

        //str += '<div class="clearfix"></div>';
        console.log(str);
        $('#brands_show').html(str);
        },
    error: function(xhr, textStatus, errorThrown) {
    ...
    /*for(var j=0;j<brandlist.length;j=j+2)
    {
        if(j%2==0)
        {
        //str += '<div class="filterDiv Core"><img src="'+imgSERVER+'/'+brandlist[j]+'" class="img-responsive"/></div>';
        str += '<div class="filterDiv Core">'+brandlist[j]+'</div>';
        }
        if(j%2==1)
        {
        //str += '<div class="filterDiv Lifestyle"><img src="'+imgSERVER+'/'+brandlist[j+1]+'" class="img-responsive"/></div>';
        str += '<div class="filterDiv Lifestyle">'+brandlist[j+1]+'</div>';
        }
    }*/
    
    //document.getElementById("brands_show").innerHTML = str;
...
function filterSelection(c) {
    ...
    if(c=='all')
     document.getElementById('header_title').innerHTML='All Partners';
     else
    document.getElementById('header_title').innerHTML=c;
...
function showBr(e){
 ...
 else
 {
    ...
    if (e=="1") {
        e='Lifestyle';
        btns[3].className += " active_btn";
        document.getElementById('header_title').innerHTML='Lifestyle';
    }
    else if (e=="2") {
        e='Core';
        btns[1].className += " active_btn";
        document.getElementById('header_title').innerHTML='Core';
    }
    else if (e=="3") {
        e='Mobility';
        btns[2].className += " active_btn";
        document.getElementById('header_title').innerHTML='Mobility';
    }
    else {
        e='all';
    document.getElementById('header_title').innerHTML='All Partners';
    ...
    $.mobile.changePage( "#mobility_partners", { transition: "none"});
    ...
    $(document).on('pageshow', '#mobility_partners', function (event, ui) {
        $("#mobility_partners").on("scroll", function(){
            var _scroll = $("#mobility_partners").scrollTop();
            //console.log(_scroll);
            if(_scroll > 75){
                $('#toTop').fadeIn();
               $(".mb_header").addClass("mb_fixed");
               }
            else {
                $('#toTop').fadeOut();
                 $(".mb_header").removeClass("mb_fixed");
            }
        })
        
        $("#toTop").click(function () {
           $("#mobility_partners").animate({scrollTop: 0}, 1000);
        });
...
// console.log("Rating:"+rating);
 ...
 if(mobile==''){
   ...
   $.ajax({
   url: SERVER+'feedback_json_owin.asp', //login.php
    type: 'POST',
    timeout: 50000,
    dataType: 'html', //xml/html/script/json/jsonp
    data: {

                'MobileNo': user.tokenid,
                'FirstName': '',
                'LastName': '',
                'EmailId': '',       
                'StoreId': bill_loc,    
...
{
    $.ajax({
            url: SERVER+'mloyallogout_json_owin.asp',
            type: 'POST',
            timeout: 30000,
            data: {
        ...
        for (var i = 0; i < data.length; i++)
            {
                ...
                listItems+= "<option value='" + data[i].value + "'>" + data[i].name + "</option>";
             } 
...
function getVoucher1(brandname, brand_name){
  ...
  //console.log('hhhhhhhhhhh'+JSON.stringify(data));
    ...
    for(var i=0;i<data.data.length;i++)
    {
         if(data.data[i].BrandId == brandname)
        {
            ...
            if(data.data[i].CouponFlag == 'Unused')
            {
...
//                      str += '<a href=javascript:showTnc(\''+brandlink+'\'); class="tncBtn">Term & Conditions</a>';
               ...
               // str += '<p class="coup_details">'+data.data[i].BrandDescription+'</p>';
                ...
                if(cimg!='')
                     {
                     /*  if (data.data[i].BrandId=='26')
                              str += '<button id=active_btn'+data.data[i].CouponId+' class="btn_primary btn_animation" data-role="none" onclick = "javascript:openInWebView1(\''+data.data[i].BrandDescription+'\',\''+data.data[i].Brand+'\');">Activate</button>';
                       
                        else if (data.data[i].BrandId=='33')
                            str += '<button id=active_btn'+data.data[i].CouponId+' class="btn_primary btn_animation" data-role="none" onclick = "javascript:activatecoupon1(\''+data.data[i].vin_number+'\',\''+data.data[i].BrandId+'\',\''+data.data[i].gvvalue+'\',\''+data.data[i].CouponId+'\',\''+data.data[i].CouponCode+'\',\''+data.data[i].CouponDescription+'\',\''+data.data[i].CouponExpiry+'\',\''+brandname+'\',\''+data.data[i].CouponImage+'\',\''+data.data[i].Brand+'\',\''+data.data[i].vin_name+'\',\''+data.data[i].vin_number+'\',\''+data.data[i].CategoryId+'\',\''+data.data[i].BrandDescription+'\');">Activate</button>';
                        
                             // str += '<button id=active_btn'+data.data[i].CouponId+' class="btn_primary btn_animation" data-role="none" onclick = "javascript:openInWebView2(\'https://b2bapi.zee5.com/cl/premium-packs.php?code=ATHMH7BS0SJ420LK&name=Hyundai\',\''+data.data[i].Brand+'\');">Activate</button>';
                       
                        
                        else*/
                              str += '<button id=active_btn'+data.data[i].CouponId+' class="btn_primary btn_animation" data-role="none" onclick = "javascript:activatecoupon1(\''+data.data[i].vin_number+'\',\''+data.data[i].BrandId+'\',\''+data.data[i].gvvalue+'\',\''+data.data[i].CouponId+'\',\''+data.data[i].CouponCode+'\',\''+data.data[i].CouponDescription+'\',\''+data.data[i].CouponExpiry+'\',\''+brandname+'\',\''+data.data[i].CouponImage+'\',\''+data.data[i].Brand+'\',\''+data.data[i].vin_name+'\',\''+data.data[i].vin_number+'\',\''+data.data[i].CategoryId+'\',\''+data.data[i].BrandDescription+'\',\''+data.data[i].offer_tnc+'\');">Activate</button>';
                      ...
                      /*if (data.data[i].BrandId=='26' )
                        ...
                        str += '<button id=active_btn'+data.data[i].CouponId+' class="btn_primary btn_animation" data-role="none" onclick = "javascript:activatecoupon1(\''+data.data[i].vin_number+'\',\''+data.data[i].BrandId+'\',\''+data.data[i].gvvalue+'\',\''+data.data[i].CouponId+'\',\''+data.data[i].CouponCode+'\',\''+data.data[i].CouponDescription+'\',\''+data.data[i].CouponExpiry+'\',\''+brandname+'\',\''+data.data[i].BrandLogo+'\',\''+data.data[i].Brand+'\',\''+data.data[i].vin_name+'\',\''+data.data[i].vin_number+'\',\''+data.data[i].CategoryId+'\',\''+data.data[i].BrandDescription+'\');">Activate</button>';

                              //str += '<button id=active_btn'+data.data[i].CouponId+' class="btn_primary btn_animation" data-role="none" onclick = "javascript:openInWebView2(\'https://https://b2bapi.zee5.com/cl/premium-packs.php?code=ATHMH7BS0SJ420LK&name=Hyundai\',\''+data.data[i].Brand+'\');">Activate</button>';
            ...
            if(cimg!='')
             ...
             str += '<div class="alpha" >';
                ...
                if(data.data[i].CouponDescription==null || data.data[i].CouponDescription==''){
                   ...
                   if(cimg!='')
                        str += '<button id=active_btn'+data.data[i].CouponId+' class="btn_primary" data-role="none" onclick = "javascript:activatecoupon1(\''+data.data[i].vin_number+'\',\''+data.data[i].BrandId+'\',\''+data.data[i].gvvalue+'\',\''+data.data[i].CouponId+'\',\''+data.data[i].CouponCode+'\',\''+data.data[i].BrandDescription+'\',\''+data.data[i].CouponExpiry+'\',\''+brandname+'\',\''+data.data[i].CouponImage+'\',\''+data.data[i].Brand+'\',\''+data.data[i].vin_name+'\',\''+data.data[i].vin_number+'\',\''+data.data[i].CategoryId+'\',\''+data.data[i].BrandDescription+'\',\''+data.data[i].offer_tnc+'\');">Activate</button>';
                  else
                      str += '<button id=active_btn'+data.data[i].CouponId+' class="btn_primary" data-role="none" onclick = "javascript:activatecoupon1(\''+data.data[i].vin_number+'\',\''+data.data[i].BrandId+'\',\''+data.data[i].gvvalue+'\',\''+data.data[i].CouponId+'\',\''+data.data[i].CouponCode+'\',\''+data.data[i].BrandDescription+'\',\''+data.data[i].CouponExpiry+'\',\''+brandname+'\',\''+data.data[i].BrandLogo+'\',\''+data.data[i].Brand+'\',\''+data.data[i].vin_name+'\',\''+data.data[i].vin_number+'\',\''+data.data[i].CategoryId+'\',\''+data.data[i].BrandDescription+'\',\''+data.data[i].offer_tnc+'\');">Activate</button>';
               }
               else
               {
                 ...
                 var cimg='';
                    if(data.data[i].CouponImage==null || data.data[i].CouponImage=='')
                        ...
                        cimg=data.data[i].CouponImage;
                 if(cimg!='')
                    str += '<button id=active_btn'+data.data[i].CouponId+' class="btn_primary" data-role="none" onclick = "javascript:activatecoupon1(\''+data.data[i].vin_number+'\',\''+data.data[i].BrandId+'\',\''+data.data[i].gvvalue+'\',\''+data.data[i].CouponId+'\',\''+data.data[i].CouponCode+'\',\''+data.data[i].CouponDescription+'\',\''+data.data[i].CouponExpiry+'\',\''+brandname+'\',\''+data.data[i].CouponImage+'\',\''+data.data[i].Brand+'\',\''+data.data[i].vin_name+'\',\''+data.data[i].vin_number+'\',\''+data.data[i].CategoryId+'\',\''+data.data[i].BrandDescription+'\',\''+data.data[i].offer_tnc+'\');">Check Details & Activate</button>';
                  else
                     str += '<button id=active_btn'+data.data[i].CouponId+' class="btn_primary" data-role="none" onclick = "javascript:activatecoupon1(\''+data.data[i].vin_number+'\',\''+data.data[i].BrandId+'\',\''+data.data[i].gvvalue+'\',\''+data.data[i].CouponId+'\',\''+data.data[i].CouponCode+'\',\''+data.data[i].CouponDescription+'\',\''+data.data[i].CouponExpiry+'\',\''+brandname+'\',\''+data.data[i].BrandLogo+'\',\''+data.data[i].Brand+'\',\''+data.data[i].vin_name+'\',\''+data.data[i].vin_number+'\',\''+data.data[i].CategoryId+'\',\''+data.data[i].BrandDescription+'\',\''+data.data[i].offer_tnc+'\');">Check Details & Activate</button>';
            ...
            //{
                ...
                str += '<div class="btn_wrapper">';
                str += '<a href="javascript:openInWebView1(\''+data.data[i].BrandDescription+'\',\''+data.data[i].Brand+'\');" class="btn_primary">Redeem</a>';
...
else
{
  ...
  //$.mobile.changePage( "#reward-coupon", { transition: "none"} ); 
    ...
    //if(ofreq=='Multiple')
    //  startloop=data.data.length-1;

    console.log('startloop'+startloop); 
    for(var i=startloop;i<len;i++)
    {
         if(data.data[i].BrandId == brandname)
        {
            brandct = brandct +1;
...
//             str += '<div class="coupon_block" style="background:url('+imgSERVER+'/'+data.data[i].BrandLogo+')">';
            ...
            str +=listItems;
                ...
                if(data.data[i].CouponDescription==null || data.data[i].CouponDescription==''){
                   ...
                   if(cimg!='')
                        str += '<button id=active_btn'+data.data[i].CouponId+' class="btn_primary btn_animation" data-role="none" onclick = "javascript:activatecoupon1(\''+data.data[i].vin_number+'\',\''+data.data[i].BrandId+'\',\''+data.data[i].gvvalue+'\',\''+data.data[i].CouponId+'\',\''+data.data[i].CouponCode+'\',\''+data.data[i].BrandDescription+'\',\''+data.data[i].CouponExpiry+'\',\''+brandname+'\',\''+data.data[i].CouponImage+'\',\''+data.data[i].Brand+'\',\''+data.data[i].vin_name+'\',\''+data.data[i].vin_number+'\',\''+data.data[i].CategoryId+'\',\''+data.data[i].BrandDescription+'\',\''+data.data[i].offer_tnc+'\');">Activate</button>';
                  else
                      str += '<button id=active_btn'+data.data[i].CouponId+' class="btn_primary btn_animation" data-role="none" onclick = "javascript:activatecoupon1(\''+data.data[i].vin_number+'\',\''+data.data[i].BrandId+'\',\''+data.data[i].gvvalue+'\',\''+data.data[i].CouponId+'\',\''+data.data[i].CouponCode+'\',\''+data.data[i].BrandDescription+'\',\''+data.data[i].CouponExpiry+'\',\''+brandname+'\',\''+data.data[i].BrandLogo+'\',\''+data.data[i].Brand+'\',\''+data.data[i].vin_name+'\',\''+data.data[i].vin_number+'\',\''+data.data[i].CategoryId+'\',\''+data.data[i].BrandDescription+'\',\''+data.data[i].offer_tnc+'\');">Activate</button>';
               }
               else
               {
         ...
         else
            {
                ...
                if (data.data[i].BrandId=='14'){
                    ...
                    else if(data.data[i].gvvalue.trim()=='9005')
                    {
                      ...
                      else if(data.data[i].gvvalue.trim()=='9004')
                     {
                        ccode='HYUNCDI15';
                ...
                else if (data.data[i].BrandId=='11'){
                    
                    if(data.data[i].CouponDescription.trim()=='Free 4 hour package worth Rs359/- on chauffeur bookings.(Available in Bengaluru, Chennai, Hyderabad, Delhi NCR, Mumbai, Pune and Ahmedabad)')
                    {
                        ccode=data.data[i].CouponCode;
                        branddesc='https://www.driveu.in/?utm_source=hyundai&utm_medium=referral&utm_campaign=app-offers&shortlink=5b347d89&pid=Hyundai&c=Hyundai&af_channel=App-Offers';
                     ...
                     {
                        ccode=data.data[i].CouponCode;
                        branddesc='https://www.driveu.in/black/?utm_source=hyundai&utm_medium=referral&utm_campaign=app-offer&shortlink=fa892cf9&pid=Hyundai&c=Hyundai&af_channel=App-Offer';
                ...
                else if (data.data[i].BrandId=='18'){
                    
                    if(data.data[i].CouponDescription.trim()=='15% additional discount on monthly Zoomcar subscription')
                    {
                        //ccode=data.data[i].CouponCode;

                        ccode='ZCSHYUNDAI';
                                 
                        branddesc='https://www.zoomcar.com/zap/subscribe/?ref=alliance-hyundai-subscriber&utm_source=alliance_hyundai&utm_campaign=subscriber';
                     ...
                     else
                     {
                        //ccode=data.data[i].CouponCode;
                        ccode='ALHYUNDAI30';
                        branddesc='https://www.zoomcar.com/?ref=alliance-hyundai-renter&utm_source=alliance_hyundai&utm_campaign=renter ';
...
/*            else if (data.data[i].BrandId=='25'){
                    
                    if(data.data[i].CouponDescription.trim()=='FREE 7 Days OnePass Red (one time)')
                    {
                        ccode=data.data[i].CouponCode;
                        branddesc='https://www.fitternity.com/onepass/pass/corporate';
                        
                    } 
                    
                   else if(data.data[i].CouponDescription.trim()=='1 Month OnePass Red @ 1499 only (one time)')
                     {
                        ccode=data.data[i].CouponCode;
                        branddesc='https://www.fitternity.com/onepass';

                     }
                     else if(data.data[i].CouponDescription.trim()=='30% Off up to INR 300 on Pay-Per-Session (2 time)')
                     {
                        ccode=data.data[i].CouponCode;
                        branddesc='https://www.fitternity.com/?_branch_match_id=797386478900677908';

                     }
                     else if(data.data[i].CouponDescription.trim()=='Get Up to 55% Off on OnePass Red and additional 5% Off up to INR 1000')
                     {
                        ccode=data.data[i].CouponCode;
                        branddesc='https://www.fitternity.com/onepass';
                     ...
                     {
                        ccode=data.data[i].CouponCode;
                        branddesc='https://www.fitternity.com/onepass/pass/corporate/swiggy';
               ...
               // str += '<img src="https://chart.googleapis.com/chart?chs=150x150&cht=qr&chl='+ccode+'" alt="" >';
                ...
                else if (data.data[i].BrandId=='34'){
                    
                        ccode='';
                        branddesc='https://www.samsung.com/in/api/v1/sso/oauth/hyundai/request?&authorization_code='+localStorage.getItem('profile_mob');

                
                }
                else if (data.data[i].BrandId=='35'){
                    
                    if(data.data[i].CouponDescription.trim()=='10% discount (up to Rs. 500/-) on Fumigation and Cleaning Services')
                    {
                        ccode=data.data[i].CouponCode;
                        branddesc='https://www.housejoy.in';
                        
                    } 
                    
                   else if(data.data[i].CouponDescription.trim()=='10% discount (up to Rs. 500/-) on Repair and Home Maintenance Services')
                     {
                        ccode=data.data[i].CouponCode;
                        branddesc='https://www.housejoy.in';
                     ...
                     {
                        ccode=data.data[i].CouponCode;
                        branddesc='https://www.housejoy.in/beauty-services';
                ...
                else if (data.data[i].BrandId=='31'){
                    
                    if(data.data[i].CouponDescription.trim()=='22% discount of Select Allopathy Rx Medicine')
                    {
                        ccode=data.data[i].CouponCode;
                        branddesc='https://www.1mg.com/?utm_source=1MG&utm_medium=Banner&utm_campaign=CBPHMIL';
                        
                    } 
                    
                   else if(data.data[i].CouponDescription.trim()=='E Diagnostics: 25% off on all available labs test')
                     {
                        ccode=data.data[i].CouponCode;
                        branddesc='https://www.1mg.com/labs?utm_source=1mg&utm_medium=Banner&utm_campaign=CBPHMIL';

                     }
                     else
                     {
                        ccode=data.data[i].CouponCode;
                        branddesc='https://www.1mg.com/online-doctor-consultation?utm_source=1mg&utm_medium=Banner&utm_campaign=CBPHMIL';
                ...
                {
                    var cocode='';
                     if(data.data[i].BrandId=='17')
                    {
                        if(data.data[i].gvvalue=='5010' || data.data[i].gvvalue=='5011' || data.data[i].gvvalue=='5012' || data.data[i].gvvalue=='5013' || data.data[i].gvvalue=='5014' || data.data[i].gvvalue=='5015')
                           { 
                            cocode='';

                            branddesc='Message sent to Revv product team, you will be contacted for redemption, within 2 hours(between 8am to 8 pm)';
                        }else{
                            cocode=data.data[i].CouponCode;
                ...
                //str += '</div>';
                str += '<div class="coupon_code_block">';
                if(data.data[i].BrandId=='37' || data.data[i].BrandId=='51')
                str += '';
                else if (data.data[i].BrandId=='17')
                    str += '<input type="text" name="couponcode'+cocode+'" id="couponcode'+cocode+'" class="coupon_code_input active" data-role="none" value="'+cocode+'" readonly>';
            ...
            //{
                ...
                str += '<div class="ui-block-b">';  
                str += '<div class="btn_wrapper">';
                str += '<a href="javascript:openInWebView1(\''+branddesc+'\',\''+data.data[i].Brand+'\');" class="btn_primary">Redeem</a>';
            ...
            */
            ...
            //str += '<p class="txtSmallMenu_offer">T&amp;C Apply* </p>';
            //console.log('data.data[i].offer_frequency_type'+data.data[i].offer_frequency_type);
             if(data.data[i].offer_frequency_type=='Multiple')
                        str += '<div class="text-center"><div class="btn_wrapper"><a href="javascript:recoupon(\''+data.data[i].BrandId+'\',\''+data.data[i].CategoryId+'\',\''+brand_name+'\',\''+data.data[i].gvvalue+'\')"; class="btn_primary2">ReGenerate Coupon</a></div></div>';
...
function getVoucher(brandname, brand_name,ofreq){
  ...
  //  console.log('hhhhhhhhhhh'+JSON.stringify(data));
         ...
         if(data.data[i].BrandId == brandname)
        {
            ...
            // str += '<h2>'+brand_name+'</h2>';
             str += '</div>';
                ...
                if(data.data[i].gvvalue=='201'){
     str+="<div class='profile_select1 offer_select'>"+
    ...
    str +=listItems20;
            ...
            //{
                ...
                if(brandname=='28')
                    {
                        if(data.data[i].gvvalue=='201')
                        str += '<a href="javascript:openInWebViewmobis1(\'model\');" class="btn_primary">Accessories</a>';
                        else
                        str += '<a href="javascript:openInWebViewmobis1(\'common\');" class="btn_primary">Accessories</a>';
    ...
    str += getVoucher1(brandname, brand_name);
...
//             str += '<div class="coupon_block" style="background:url('+imgSERVER+'/'+data.data[i].BrandLogo+')">';
            ...
            if(data.data[i].CouponFlag == 'Issued')
            {
               ...
               // str += '<p class="coup_details">'+data.data[i].BrandDescription+'</p>';
                str += '<div class="text-center">';
                                ...
                                console.log('kkkkkkkkkkkkkkkkkkkk'+data.data[i].CouponImage);
         ...
         else
            {
                ...
                var branddesc='';
                //str += '<img src="https://chart.googleapis.com/chart?'+data.data[i].CouponCode+'&chs=150x150" alt="" >';
                if (data.data[i].BrandId=='33')
                    {
                        ccode='';

                    }
                else if(data.data[i].BrandId=='26'){
                    ccode='';
                    branddesc='https://www.eazydiner.com/premium-prime-dining?plan_types[]=hyundai_sale';
                        

                }
                else if(data.data[i].BrandId=='46'){
                    //ccode='';
                    var name = localStorage.getItem('firstname');
                    var email = localStorage.getItem('emailid');
                    var mob = localStorage.getItem("profile_mob");
                    branddesc='https://www.vlccwellness.com/India/centre-locator-new/?utm_source=HYUNDAI&utm_medium=%20HYUNDAI_APP&camp=VLCCHYDI21&utm_campaign=%20HYUNDAI%20_OFFER&name='+name+'&email='+email+'&phoneno='+mob+'&offer=Vlccoffer&offertype=offer';
                        

                }
                else if (data.data[i].BrandId=='14'){
                ...
                else
                {
                                ...
                                console.log('kkkkkkkkkkkkkkkkkkkk'+data.data[i].CouponFlag);
            ...
            //{
                ...
                str += '<div class="btn_wrapper">';
                 if (data.data[i].BrandId=='33')
                 str += '<a href="javascript:openInWebView2(\'https://b2bapi.zee5.com/v2/cl/premium-packs.php?code=ATHMH7BS0SJ420LK&name=Hyundai\',\''+data.data[i].Brand+'\');" class="btn_primary">Redeem </a>';
                else if (data.data[i].BrandId=='51') {

                     str += '<a href="javascript:openInWebView3();" class="btn_primary">Redeem </a>';
                

                }
                 else if(data.data[i].BrandId=='27')
                 {
...
function recoupon(brandid,catid,brandname,gvvalue)
{
...
//https://mmpdev.hyundai.co.in/autoever/apis/issue_single_coupon_json_api.asp?apiuid=MLOYALAPI&apipswd=Ml0yalAP!2o20&mobileno=9818747077&brandid=5&gvvalue=200
        $.ajax({
        url: SERVER1+'apis/issue_single_coupon_json_api_owin.asp',
        type: 'POST',
        timeout: 50000,
        dataType: 'json', //xml/html/script/json/jsonp
        data: {'mobileno': user.tokenid,'brandid':brandid,'gvvalue':gvvalue},
        success: function(data, textStatus, xhr) {
        if(data.data.length>0){
        getCatVou(catid);
        getVoucher(brandid, brandname,'Multiple');  
         }
         else
         {
            toast(data.error)
...
function activatecoupon(couponid,couponcode,offername,couponexpiry,brandname,brandimage, brand_name,vinname,vinno,catid,branddesc,offer_tnc)
{

    var itemcode='';//$('#itemname'+couponid).val();
    ...
    setTimeout(function(){
        ...
        $.ajax({
        url: SERVER1+'apis/activate_issued_coupon_json_api_owin.asp',
        type: 'POST',
        timeout: 50000,
        dataType: 'json', //xml/html/script/json/jsonp
        data: {'mobileno': user.tokenid,'CouponId':couponid,'CouponCode':couponcode,'item_variance':itemcode},
        success: function(data, textStatus, xhr) {
           ...
           if(brandname=='33'){
            ...
            else if(brandname=='26')
            {
             ...
             {      //ccode='';
            ...
            else if(brandname=='14'){
                    couponexpiry='07/01/2021';
                    if(offername.trim()=='30% off on Self Drive Rentals in India')
                    {
                        couponcode='HYUNSD30';
                        branddesc='https://www.avis.co.in/landingpage-avis-Hyundai-SDdom.aspx?utm_medium=Hyundai_SD&utm_source=Alliance';
                    ...
                    else if(offername.trim()=='35% off on Chauffeur Drive Rentals in India')
                    {
                     ...
                     else if(offername.trim()=='15% off on International Chauffeur Drive Rentals')
                     {
                        ccode='HYUNCDI15';
                        branddesc='https://www.avis.co.in/landingpage-avis-Alliance_Hyundai-CDint.aspx?utm_medium=CD_Int&utm_source=Allaince_Hyundai';
                    ...
                    if(offername.trim().trim()=='Free 4 hour package worth Rs359/- on chauffeur bookings.(Available in Bengaluru, Chennai, Hyderabad, Delhi NCR, Mumbai, Pune and Ahmedabad)')
                    {
                ...
                else if (brandname=='18'){
                    
                    if(offername.trim()=='15% additional discount on monthly Zoomcar subscription')
                    {
                        couponcode='ZCSHYUNDAI';
                 ...
                 else if (brandname=='31'){
                    
                    if(offername.trim()=='22% discount of Select Allopathy Rx Medicine')
                    {
                   ...
                   else if(offername.trim()=='E Diagnostics: 25% off on all available labs test')
                     {
                        branddesc='https://www.1mg.com/labs?utm_source=1mg&utm_medium=Banner&utm_campaign=CBPHMIL';
...
/*              else if (brandname=='25'){
                    
                    if(offername.trim()=='FREE 7 Days OnePass Red (one time)')
                    {
                   ...
                   else if(offername.trim()=='1 Month OnePass Red @ 1499 only (one time)')
                     {
                        
                        branddesc='https://www.fitternity.com/onepass';

                     }
                     else if(offername.trim()=='30% Off up to INR 300 on Pay-Per-Session (2 time)')
                     {
                        
                        branddesc='https://www.fitternity.com/?_branch_match_id=797386478900677908';

                     }
                     else if(offername.trim()=='Get Up to 55% Off on OnePass Red and additional 5% Off up to INR 1000')
                     {
                ...
                */
                else if (brandname=='35'){
                    
                    if(offername.trim()=='10% discount (up to Rs. 500/-) on Repair and Home Maintenance Services')
                    {
                   ...
                   else if(offername.trim()=='10% discount (up to Rs. 500/-) on Fumigation and Cleaning Services')
                     {
            ...
            var str = '';
                // str += '<div style="padding:0 20px">';
                 str += '<div class="active_coupon_inner">';
            ...
            //  {
                    ...
                    //str += '<div class="btn_wrapper">';
                        ...
                        if(offer_tnc==''|| typeof offer_tnc == undefined || offer_tnc == null)
                    brandlink='';
                    else
                    brandlink=TNCURL+offer_tnc; 
                ...
                catch(r)
                {
                    ...
                    str += '<div class="ui-block-b">';  
                    str += '<div class="btn_wrapper">';
                    str += '<a href="javascript:openInWebView1(\''+branddesc+'\',\''+brand_name+'\');" class="btn_primary">Redeem </a>';
                    str += '</div>';
                    str += '</div>';
                    str += '</div>';
                    str += '</div>';
...
function activatecoupon1(vinno,bid,gvval,couponid,couponcode,offername,couponexpiry,brandname,brandimage, brand_name,vinname,vinno,catid,branddesc,offer_tnc)
{
    /*
    try{
   ...
   if(vinno.trim().length<17)
    ...
    setTimeout(function(){
        ...
        //https://mmpdev.hyundai.co.in/autoever/apis/activate_issued_coupon_json_api.asp?apiuid=MLOYALAPI&apipswd=Ml0yalAP!2o20&mobileno=XXXXXXXXXX&CouponId=XX&CouponCode=XXXXXXXX
        $.ajax({
        url: SERVER1+'apis/activate_coupon_json_api_owin.asp',
        type: 'POST',
        timeout: 50000,
        dataType: 'json', //xml/html/script/json/jsonp
        data: {'mobileno': user.tokenid,'vehiclenumber':vinno,'brand_id':bid,'denomination':gvval,'item_variance':itemcode},
        success: function(data, textStatus, xhr) {
     if(data.data=='Coupons not Issued.')
        {
            toast('Coupon not activated!!');

        }else if(data.data[0].message='Coupons activated successfully.'){
                ...
                {       //ccode='';
                    ...
                    if(offername.trim()=='10% discount (up to Rs. 500/-) on Repair and Home Maintenance Services')
                    {
                     ...
                     else
                     {
                        ...
                        if(gvval=='5010' || gvval=='5011' || gvval=='5012' || gvval=='5013' || gvval=='5014' || gvval=='5015')
                          { 
                            couponcode='';
            ...
            var str = '';
                ...
                if(brandname=='33' || brandname=='26' || brandname=='37' || brandname=='34')
                {
                    str += '';
                ...
                str += '</div>';
                if(brandname=='33' || brandname=='26' || brandname=='37')
                {
                    str += '';
            ...
            //  {
                ...
                catch(r)
                {
                    ...
                    if(brandname=='33')
                        str += '<a href="javascript:openInWebView2(\'https://b2bapi.zee5.com/v2/cl/premium-packs.php?code=ATHMH7BS0SJ420LK&name=Hyundai\',\''+brand_name+'\');" class="btn_primary">Redeem </a>';
                    else if(brandname=='51')
                        str += '<a href="javascript:openInWebView3();" class="btn_primary">Redeem </a>';    
                    else
                    str += '<a href="javascript:openInWebView1(\''+branddesc+'\',\''+brand_name+'\');" class="btn_primary">Redeem </a>';
...
if(brandname=='28'){
                if(gvval=='201'){
     str+="<div class='profile_select1 offer_select'>"+
    '<select name=itemname1 id="itemname1" class=additional_control  data-role=none data-mini=true data-inline=true>';
    ...
    str +=listItems20;
                ...
                if(brandname=='33' || brandname=='26' || brandname=='37' || brandname=='28')
                {
                    str += '';
               ...
               // str += '<h3 class="vehicle_type">Vehicle : '+vinname+' <span>('+vinno+')</span></h3>';
                ...
                catch(r)
                {
                    ...
                    {
                        if(gvval=='201')
                        str += '<a href="javascript:openInWebViewmobis(\'model\');" class="btn_primary">Accessories</a>';
                        else
                        str += '<a href="javascript:openInWebViewmobis(\'common\');" class="btn_primary">Accessories</a>';
...
{
    /* Select the text field */
  var aux=document.getElementById('ccopon');
...
function rateApp()
{
    ...
    'If you enjoy using Hyundai Mobility Membership , would you mind taking a moment to rate it? It won\'t take more than a minute. Thanks for your support!',
    function(button) {
        // yes = 1, no = 2, later = 3
        if (button == '1') {    // Rate Now
            if (deviceType=='Android') {
                // window.open('market://details?id=com.mobiquest.mmphyundai');
              window.location.href='market://details?id=com.mobiquest.mmphyundai';
               
            } 
            else {

                 //window.open('itms-apps://itunes.apple.com//in/app/hyundai-mobility-membership/id1526843771?ls=1&mt=8'); // or itms://
                window.location.href='itms-apps://itunes.apple.com//in/app/hyundai-mobility-membership/id1526843771?ls=1&mt=8';
    ...
    }, 'Rate Hyundai MMP', ['Rate Hyundai MMP', 'Remind me later', 'No Thanks']);
...
if($("#vehother").prop('selectedIndex')!=1){
  ...
  $.ajax({
   url: SERVER1+'apis/get_vehicle_json_api_owin.asp',
   type: 'POST',
   timeout: 50000,
    dataType: 'json',
     data: {'mobileno': user.tokenid,'vinnumber':vinno},
    complete: function(xhr, textStatus) {
    },
    success: function(data, textStatus, xhr) {
   ...
   if(data.data.length>0)
   {
           ...
           // listItems=   localStorage.getItem('vehdet');
            str +=listItems;
                ...
                str +='<h2> <a href="#" onclick="javascript:toggleDetails(this)">Vehicle Details<img src="images/arrow_icon.png" class="img-responsive rotate_90" alt /></a></h2>';
                ...
                str +='<li><h3>Vehicle Registration Number:</h3><span class="member_role" id="vinregistrationnumber">'+data.data[0].vin_registration_number+'</span></li>';
                ...
                str +='</div>';
                str +='<div class="vin_details">';              
                str +='<h2> <a href="#" onclick="javascript:toggleDetails(this)">Dealer Details<img src="images/arrow_icon.png" class="img-responsive" alt /></a></h2>';
                str +='<ul>';
                ...
                str +='<li><h3>Dealer City:</h3><span class="member_role" id="sellingdealercity">'+data.data[0].selling_dealer_city+'</span></li>';
                str +='</ul>';
                str +='</div>';
                /*str +='<div class="vin_details">';
     ...
     else 
     {
                ...
                str +='<li><h3>Vehicle Registration Number:</h3><span class="member_role" id="vinregistrationnumber">'+checkforundefined(user.vinRegistrationNumber)+'</span></li>';
               ...
               // str +='<li><h3>Dealer No:</h3><span class="member_role" id="sellingdealerno">'+checkforundefined(user.sellingdealernumber)+'</span></li>';
                str +='<li><h3>Dealer City:</h3><span class="member_role" id="sellingdealercity">'+checkforundefined(user.sellingDealerCity)+'</span></li>';
                str +='</ul>';
                str +='</div>';
              /*  str +='<div class="vin_details">';
                str +='<h2>RO Details <a href="#" onclick="javascript:toggleDetails(this)"><img src="images/arrow_icon.png" class="img-responsive" alt /></a></h2>';
   ...
   if(data.data.length>0)
   {
           ...
           var listItems= "<div class=profile_select>"+
            ...
            str +=listItems;
                ...
                str +='<h2><a href="#" onclick="javascript:toggleDetails(this)">Vehicle Details <img src="images/arrow_icon.png" class="img-responsive rotate_90" alt /></a></h2>';
                str +='<ul style="display:block">';
                str +='<li><h3>Relation:</h3><span class="member_role" id="vinservicemodelcode">'+checkforundefined(user.vinServiceModelCode)+'</span></li>';
    ...
    success: function(data, textStatus, xhr) {
        ...
        if(data == 'Y' || data == 'V')
        {
            ...
            success: function(data, textStatus, xhr) {
                ...
                str +='<li><h3>Vehicle Registration Number:</h3><span class="member_role" id="vinregistrationnumber">'+data.vinRegistrationNumber+'</span></li>';
                ...
                str +='<ul>';
                str +='<li><h3>Sales Dealer Name:</h3><span class="member_role" id="sellingdealername">'+data.sellingDealerName+'</span></li>';
...
function showvdetail()
{
    ...
    localStorage.setItem('salesname',$('#sales_name').val());
    localStorage.setItem('relation',$('#rel').val());
    var uname = localStorage.getItem('usernamehyundai');
    $.ajax({
 ...
 $("#vehicle-link-new-rc").css('display', 'none');
  $("#vehicle-msg-new").css('display', 'none');
   $("#vehicle-link-rc").css('display', 'none');
    $("#vehicle-link-msg").css('display', 'none');
                ...
                str +='<h2 class="text-left">Give your vehicle a nickname:</h2>';
                
                str +='<div class="vin_details">';
                  str +='<div class="profile_input" style="margin-bottom:0">'+
                           '<input type="text" placeholder="Enter Vehicle Name" autocomplete="off" style="border:none"  data-role="none" id="vin_name" />'+
                        '</div>'+
                ...
                str +='<li><h3>Vehicle Registration Number:</h3><span class="member_role" id="vinregistrationnumber">'+checkforundefined(data.vinRegistrationNumber)+'</span></li>';
               ...
               // str +='<li><h3>Service Model Code:</h3><span class="member_role" id="vinservicemodelcode">'+checkforundefined(data.vinservicemodelcode)+'</span></li>';
                ...
                str +='<li><h3>Exterior Colour:</h3><span class="member_role" id="vinexteriorcolor">'+checkforundefined(data.vinExteriorColor)+'</span></li>';
                ...
                str +='<li><h3>Dealer Name:</h3>';
                 ...
                 str +='<div class="ui-grid-solo">'+
                    '<div class="ui-block-a">'+                     
                        '<div class="profile_input" style="margin-bottom:0">'+
                            '<input type="text"  data-role="none" id="sellingdealername" value="'+checkforundefined(data.sellingDealerName)+'"/>'+
                        '</div>'+
                   '</div>'+
               '</div>';

                //str +='<span class="member_role" id="sellingdealername">'+checkforundefined(data.sellingDealerName)+'</span>';
                str +='</li>';
                //str +='<li><h3>Dealer No:</h3><span class="member_role" id="sellingdealerno">'+checkforundefined(data.sellingdealernumber)+'</span></li>';
                str +='<li><h3>Dealer City:</h3><span class="member_role" id="sellingdealercity">'+checkforundefined(data.sellingDealerCity)+'</span></li>';
                str +='</ul>';
                str +='</div>';
                str +='<div class="vin_details">';
                /*str +='<h2>RO Details <a href="#" onclick="javascript:toggleDetails(this)"><img src="images/arrow_icon.png" class="img-responsive" alt /></a></h2>';
                ...
                str +='</ul>';
                str +='</div>';*/
                str +='<div class="text-center mb-20 mt-20"><a href="javascript:customerRegistrationcheck();" class="btn_primary">Confirm</a></div>';
        ...
        else
        {
            ...
            $.mobile.changePage( "#failpage", { transition: "none"} );
            document.getElementById("errorfunction").href="javascript:showHome2();";
            document.getElementById("faildesc").innerHTML = 'Vehicle Identification Number (VIN) is not eligible for membership';
...
function showvdetail_new()
{
    ...
    localStorage.setItem('salesname',$('#sales_name_new').val());
    localStorage.setItem('relation',$('#rel_new').val());
    var uname = localStorage.getItem('usernamehyundai');
    $.ajax({
    ...
    success: function(data, textStatus, xhr) {
        ...
        if(data == 'Y')
        {
            ...
            success: function(data, textStatus, xhr) {
                ...
                $("#vehicle-link-new-rc").css('display', 'none');
  $("#vehicle-link-new-msg").css('display', 'none');
   $("#vehicle-link-rc").css('display', 'none');
    $("#vehicle-link-msg").css('display', 'none');
                ...
                var str= ""; 
               str+= '<h2 class="login_heading2 text-left">Give your vehicle a nickname:</h2>';
                str +='<div class="vin_details">';
                str +='<div class="ui-grid-solo">'+
                    '<div class="ui-block-a">'+                     
                        '<div class="profile_input" style="margin-bottom:0">'+
                            '<input type="text" style="border:none"  data-role="none" id="vin_name_new" />'+
                        '</div>'+
                   '</div>'+
               '</div>';
                 str +='</div>';
                ...
                str +='<li><h3>Vehicle Registration Number:</h3>';
              ...
              //  str +='<li><h3>HAP Insurance Policy:</h3>';
                ...
                str +='<ul>';
                 ...
                 str +='<div class="ui-grid-solo">'+
                    '<div class="ui-block-a">'+                     
                        '<div class="profile_input" style="margin-bottom:0">'+
                            '<input type="text"  data-role="none" id="sellingdealername_new" value="'+checkforundefined(data.sellingDealerName)+'"/>'+
                        '</div>'+
                   '</div>'+
               '</div>';
        ...
        else
        {
            ...
            success: function(data, textStatus, xhr) {
                ...
                str +='<li><h3>Sales Sales Sales Sales Dealer Name:</h3><span class="member_role" id="sellingdealername">'+data.sellingDealerName+'</span></li>';
                str +='<li><h3>Dealer No:</h3><span class="member_role" id="sellingdealerno">'+data.sellingdealernumber+'</span></li>';
                str +='<li><h3>Selling Dealer City:</h3><span class="member_role" id="sellingdealercity">'+data.sellingDealerCity+'</span></li>';
                str +='</ul>';
                str +='</div>';
...
function checkname(str)
{
    ...
    toast('Name should be less than 60 characters');
    $('#'+str).val(str1.slice(0, 60));
    
    return (false);
     }
}

function checkaddess(str)
{
    var str1 = $('#'+str).val();
    ...
    toast('Address should be less than 150 characters');
    $('#'+str).val(str1.slice(0, 60));
...
function checkcustomerexists_mmp(mob,vin)
{
         ...
         $.ajax({
            ...
            data: {'mobileno': mob,'vinNumber':vin},
            success: function(data, textStatus, xhr) {
            // console.log(data.data);
             //console.log(textStatus);
        if(data.error=='Member not registered.') {
            ...
            //  console.log('sssssssssssssss'+JSON.stringify(data));
                ...
                for(var i=0;i<data.length;i++)
                {
                    ...
                    str += '<h3 class="sos_name">'+data[i].question+'</h3>';
                     ...
                     str += '<h4 class=sos_number><a href=tel:'+data[i].answer1+'><img src="images/call_SOS.png" alt="Call Icon" class="call_icon">'+data[i].answer1+'</a></h4>';  
    ...
    var complaint = $('#Comments_complaint').val();
     if(complaint==''){
          toast('You have not entered your problem');
            ...
            $.ajax({
            url: SERVER+'feedback_json_owin.asp',
            type: 'POST',
            timeout: 30000,
            data: {
            ...
            success: function(data, textStatus, xhr) {
                ...
                toast('Your query has been successfully submitted');
...
//https://uatclicktobuy.hyundai.co.in/ctb/customer/forgot-password/change-via-email.ctb
    if(logintype == 'Mobile')
    {
        ...
        $.ajax({
            ...
            complete: function(xhr, textStatus) {
               ...
               else if(data.dataVO[0].message=='Customer does not exist in db')
               {
                toast('Not a valid registered user');
               }
               else
               {
                toast(data.dataVO[0].message);
    ...
    if(eml=='')
        ...
        $.ajax({
                url: CTBSERVER+'/forgot-password/change-via-email.ctb',
                type: 'POST',
                timeout: 50000,
                dataType: 'json',
            ...
            complete: function(xhr, textStatus) {
                ...
                if(data.dataVO[0].message == 'Password change was successful for Forgot Password request.')
               {
                //https://mmpdev.hyundai.co.in/autoever/apis/get_mobile_byemail_json_api.asp?apiuid=MLOYALAPI&apipswd=Ml0yalAP!2o20&email=vikash@mobiquest.com
                    $.ajax({
                url: SERVER1+'apis/get_mobile_byemail_json_api.asp',
                type: 'POST',
                timeout: 30000,
                dataType:'json',
                data: {'email': user},
...
var data={"data":[{"stateid":1,"statename":"ANDAMAN & NICOBAR ISLANDS","statecode":"AN"},{"stateid":2,"statename":"ANDHRA PRADESH","statecode":"AP"},{"stateid":26,"statename":"Arunachal Pradesh","statecode":"AR"},{"stateid":27,"statename":"Assam","statecode":"AS"},{"stateid":3,"statename":"BIHAR","statecode":"BR"},{"stateid":4,"statename":"CHANDIGARH","statecode":"CH"},{"stateid":5,"statename":"CHATTISGARH","statecode":"CG"},{"stateid":6,"statename":"DADRA & NAGAR HAVELI","statecode":"DN"},{"stateid":28,"statename":"Daman And Diu","statecode":"DD"},{"stateid":8,"statename":"DELHI","statecode":"DL"},{"stateid":29,"statename":"Goa","statecode":"GA"},{"stateid":9,"statename":"GUJARAT","statecode":"GJ"},{"stateid":10,"statename":"HARYANA","statecode":"HR"},{"stateid":11,"statename":"HIMACHAL PRADESH","statecode":"HP"},{"stateid":12,"statename":"JAMMU & KASHMIR","statecode":"JK"},{"stateid":13,"statename":"JHARKHAND","statecode":"JH"},{"stateid":25,"statename":"Karnataka","statecode":"KA"},{"stateid":14,"statename":"KERALA","statecode":"KL"},{"stateid":38,"statename":"Ladakh","statecode":"LA"},{"stateid":30,"statename":"Lakshadweep","statecode":"LD"},{"stateid":15,"statename":"MADHYA PRADESH","statecode":"MP"},{"stateid":16,"statename":"MAHARASHTRA","statecode":"MH"},{"stateid":32,"statename":"Manipur","statecode":"MN"},{"stateid":31,"statename":"Meghalaya","statecode":"ML"},{"stateid":33,"statename":"Mizoram","statecode":"MZ"},{"stateid":34,"statename":"Nagaland","statecode":"NL"},{"stateid":17,"statename":"ODISHA","statecode":"OR"},{"stateid":35,"statename":"Puducherry","statecode":"PY"},{"stateid":18,"statename":"PUNJAB","statecode":"PB"},{"stateid":19,"statename":"RAJASTHAN","statecode":"RJ"},{"stateid":36,"statename":"Sikkim","statecode":"SK"},{"stateid":20,"statename":"TAMIL NADU","statecode":"TN"},{"stateid":21,"statename":"TELANGANA","statecode":"TS"},{"stateid":37,"statename":"Tripura","statecode":"TR"},{"stateid":22,"statename":"UTTAR PRADESH","statecode":"UP"},{"stateid":23,"statename":"UTTARAKHAND","statecode":"UK"},{"stateid":24,"statename":"WEST BENGAL","statecode":"WB"}],"error":[]}
        ...
        for (var i = 0; i < data.data.length; i++)
            {
                listItems+= "<option value='" + data.data[i].stateid +"-"+ data.data[i].statecode + "'>" + data.data[i].statename.toUpperCase()+ "</option>";
            } 
    ...
    success: function(data, textStatus, xhr) {
        ...
        for (var i = 0; i < data.data.length; i++)
        {
            ...
            if(data.data[i].citycode!=null) 
            {
                    ...
                    listItems+= "<option  value='" + data.data[i].cityid + "-" + data.data[i].citycode + "'>" + data.data[i].cityname.toUpperCase() + "</option>";  
            }
...
if(localStorage.getItem('vinno')==null || localStorage.getItem('vinno')=='')
{
listItems+= "<div class=\"notifications_thread\" >";

listItems+= "<div class=\"notifications_img\"><img src=\"images/shopping_icon.png\" class=\"img-responsive\"></div>";

listItems+="<div class=\"notification_content\"><p class=\"noti_text\">Verify your VIN to check exciting deals now!! Click on either Core, Mobility or Lifestyle icon on app homepage to link your vehicle.</p>";
listItems+="<p class=\"noti_date\">"+setime+"</p>";
listItems+="</div>";
listItems+="</div>";
listItems+="</div>";
}
...
listItems+="<div class=\"notification_content\"><p class=\"noti_text\">Congratulations.!! </br>You are now member of Hyundai Mobility Membership program.Explore category Core, Mobility and Lifestyle to find out your best brand and their offers.</p>";
listItems+="<p class=\"noti_date\">"+setime+"</p>";
listItems+="</div>";
listItems+="</div>";
listItems+="</div>";
...
function onImgError(source){
        source.src = "images/No_image.jpg";
        source.onerror = ""; 
        return true; 
    } 
...
function showmymCard()
{
    ...
    document.getElementById("cardname").innerHTML = user.firstname+' '+user.lastname;
    document.getElementById("cardid").innerHTML ='Membership No: '+ user.id;
    if(localStorage.getItem('vinno')==null || localStorage.getItem('vinno')=='')
    {
    document.getElementById("owner").innerHTML =' Ownership Verified: No';

    }else
    {
        document.getElementById("owner").innerHTML =' Ownership Verified: Yes';
      document.getElementById("vin_no").innerHTML ='Vin No: '+ localStorage.getItem('vinno');
    }
    //document.getElementById("barimg").innerHTML = '<img src="https://quickchart.io/qr?text='+user.id+'&size=80&margin=2" style="padding:10px;"/>';


    $.mobile.changePage( "#mycard_page", { transition: "none"} );
